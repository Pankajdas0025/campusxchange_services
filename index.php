...
<div class="slider-box" id="sliderBox">
  <div class="slider-images" id="slider">
    <img src="assets/Images/notes-website-mockup.png" alt="notes-website-mockup">
    <img src="assets/Images/memmory-puzzle-game-website.png" alt="memmory-puzzle-game-website-mockup">
    <img src="assets/Images/paramount-website-mockup.png" alt="paramount-website-mockup">
    <img src="assets/Images/addmission-website.png" alt="addmission-website-mockup">
    <img src="assets/Images/blogscriptapp-website-mockup.png" alt="blogscriptapp-website-mockup">
  </div>
</div>
...
<!-- in which we show our work done section end here  ------------------------------------------------------------------------------------------------>
    <br>
<!-- Assignment section  ------------------------------------------------------------------------------------------------>
...
<br>
<br>
Whether you're passionate about crafting pixel-perfect frontends or building powerful backend logic, you'll work on real-world projects under expert mentorship. Here, you'll gain full-stack experience, contribute to meaningful development, and grow into the developer the industry wants.</P>
      <br>
      <a href="internship-program"><button>Check Our Internship Program</button></a>
      </div>
    </section>
    <br>
    <!-- FAQ section ---------------------------------------------------------------------------------->
  ...
  <div class="faq">
    ...
    <div class="faq-answer">
      CampusXchange is your go-to platform for real-world learning, offering tech notes, development projects, internships, SEO services, and mentorship — all in one place!
    </div>
  </div>
...
<ul style="list-style: none;">
  ...
  <li>✅Database & CRUD Applications</li>
  <li>✅PHP, JavaScript, Python-based Projects</li>

</ul></div>
  </div>

  <div class="faq">
    <div class="faq-question">What kind of internships do you offer?</div>
    <div class="faq-answer">
      We offer hands-on internships in Web Development, SEO, Content Writing, and more. These are designed to be practical, project-based, and often come with certification.
    </div>
  </div>

  <div class="faq">
    <div class="faq-question">Is the mentorship program paid?</div>
    <div class="faq-answer">
      Some mentorships are free, while advanced, guided sessions with industry mentors might come with a small fee to cover expert time. All options are budget-friendly.
    </div>
  </div>

  <div class="faq">
    <div class="faq-question">Can I access CampusXchange resources for free?</div>
    <div class="faq-answer">
      Absolutely! Notes, blogs, and several learning materials are freely accessible. Premium content and services are optional for advanced learners.
    </div>
  </div>
</section>
<br>
...
<!-- Quick Links  -->
     <h3>Quick Links-</h3>
     <div  id="quicklinks">
  <a href="home" class="active" style="color: #000000;">Home</a>  <a href="services/web-development" title="Web Development From CampusXchange">Website Development</a><a href="services/seo">SEO</a><a href="handouts/notes" title="Technical Notes">Notes</a><a href="handouts/blog" title="Scripted Blogs">Blogs</a><a href="handouts/assignment" title="Programming Lab Assignment">Programming Assignment</a><a href="internship-program">Mentorship & Internship</a><a href="about">About</a><a href="lettalk">Let's Talk</a>
     </div>
<br>
<br>
<!-- Contact Links  -->
