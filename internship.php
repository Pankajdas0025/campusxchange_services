...
<head>
  ...
  <title>Mentorship & Remote Internship - CampusXchange</title>
...
<section class="mentor-section">
  ...
  <div class="block mentor-card">
    ...
    <ul>
      ...
      <li>SEO & Digital Marketing Internship</li>
      <li>Content Writing Internship</li>
  ...
  <div class="block mentor-card">
    ...
    <ul>
      ...
      <li>Freelancing & startup guidance</li>
...
<!-- demo certificate and projects section --------------------------->
<section class="demo-section">
  ...
  <div class="demo-flex">
    ...
    <div class="demo-projects">
      ...
      <ul>
        <li>Portfolio Website (Web Development)</li>
        <li>SEO Audit Report (SEO & Digital Marketing)</li>
        <li>Technical Blog Series (Content Writing)</li>
        <li>Sales Data Dashboard (Data Analytics)</li>
      </ul>
      <p>Interns work on real-world projects and build a strong portfolio.</p>
    </div>
  </div>
</section>
...
<script>
  ...
  document.querySelectorAll('#demo-certificate-img').addEventListener('', () => {
    const certificateImg = document.getElementById('demo-certificate-img');
    if (certificateImg.style.transform === 'scale(1.5)') {
      certificateImg.style.transform = 'scale(1)';
    } else {
      certificateImg.style.transform = 'scale(1.5)';
    }
  });
</script>
<br>
