...
document.getElementById("seoForm").addEventListener("submit", function(event){
  ...
  let url = "https://wa.me/" + whatsappNumber + "?text="
            ...
            + "Website URL : " + Weburl + "%0a%0a"
            + "I am interested in your SEO services. Can you please share more details?";
...
<p>Whether you're in e-commerce, education, healthcare, or finance, CampusXchange tailors SEO strategies to fit your industry and audience, helping you gain visibility and drive growth.</p>
  ...
  <div class="industry">
    ...
    <div class="industrytype"><i class="fa-solid fa-stethoscope"></i> Healthcare</div>
    <div class="industrytype"><i class="fa-solid fa-building-columns"></i> Finance</div>
    <div class="industrytype"><i class="fa-solid fa-car"></i> Travel & Tourism</div>
    <div class="industrytype"><i class="fa-solid fa-building"></i> Real Estate</div>
    <div class="industrytype"><i class="fa-solid fa-laptop-code"></i> Technology</div>
    <div class="industrytype"><i class="fa-solid fa-clapperboard"></i> Entertainment</div>
  </div>
 </section>
 <br>
