...
<span>Ideal for: Startups, online stores, scalable business platforms.</span></div></div>
 ...
 <!-- Website development price plan end here ------------------------------------------------------------------>
 <br>
 <!-- doupplanprice CTA button --------------------------------------------------------------------------------->
 <div class="animationtype2 doughtplanprice">
🤔 Not sure which package fits your needs? Click below and let's discuss it on WhatsApp.
<br><br>
...
<div class="planordercontact-form">
  ...
  <input type="Address" placeholder="Enter your local Address" id="client_address" name="client_address"  required>
  <select id="client_websitetype" name="client_websitetype" required>
    <option disabled selected style="opacity: 0.9; color: #757c76;">Which type of website you want</option>
  ...
  <select id="client_plantype" name="client_plantype" required>
    <option disabled selected style="opacity: 0.9; color: #757c76;">Select best plan </option>
    <option>Basice</option>
...
<div class="happyabout">
  <div class="clientsfeedback">
    <img src="../assets/Images/client.png" id="clientimg">
    <div class="feedbackcontent">
      <h2 id="clientpossition">Testimonials</h2>
      <p id="clientrating">⭐⭐⭐⭐</p>
    ...
    faq.querySelector(".webdevlopmentfaq-question").addEventListener("click", () => {
      ...
      faqs.forEach(otherFaq => {
        if (otherFaq !== faq) {
          ...
          otherFaq.querySelector(".webdevlopmentfaq-answer").style.display = "none";
        }
      });
    });
  });
